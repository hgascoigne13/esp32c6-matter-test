...
void bh1750_sensor_init(i2c_dev_t * bh1750_dev_descriptor) {
    ...
    ESP_ERROR_CHECK(bh1750_init_desc(bh1750_dev_descriptor, BH1750_ADDR, (i2c_port_t)0, (gpio_num_t) CONFIG_EXAMPLE_I2C_MASTER_SDA, (gpio_num_t) CONFIG_EXAMPLE_I2C_MASTER_SCL));
...
esp_matter_attr_val_t bh1750_sensor_update(i2c_dev_t * bh1750_dev_descriptor) {
    ...
    esp_matter_attr_val_t lux_ret = esp_matter_nullable_int16(nullable<int16_t>(lux));
...
void scd30_sensor_init(i2c_dev_t * scd30_dev_descriptor) {
    ...
    ESP_ERROR_CHECK(scd30_init_desc(scd30_dev_descriptor, (i2c_port_t)0, (gpio_num_t)CONFIG_EXAMPLE_I2C_MASTER_SDA, (gpio_num_t)CONFIG_EXAMPLE_I2C_MASTER_SCL));
